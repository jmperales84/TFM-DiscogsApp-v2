        ...
        if init:
            ...
            if self.partition_by:
                ...
                writer = (writer.partitionBy(*self.partition_by)
                          if isinstance(self.partition_by, (list, tuple))
                          else writer.partitionBy(self.partition_by))
            writer.save()
            ...
            writer = (df.write
                        ...
                        .options(**self.bronze_options))
            # Partition is not necessary this time because partitioning is fixed at table creation.
